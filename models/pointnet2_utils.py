...
try:
    from models.pointnet2_cuda_ops import farthest_point_sample_cuda, query_ball_point_cuda
except ImportError:
    try:
        from pointnet2_cuda_ops import farthest_point_sample_cuda, query_ball_point_cuda
    except ImportError:
        farthest_point_sample_cuda = None
        query_ball_point_cuda = None
...
def farthest_point_sample(xyz, npoint):
    ...
    """
    if farthest_point_sample_cuda is not None:
        centroids = farthest_point_sample_cuda(xyz, npoint)
...
def query_ball_point(radius, nsample, xyz, new_xyz):
    ...
    """
    if query_ball_point_cuda is not None:
        group_idx = query_ball_point_cuda(radius, nsample, xyz, new_xyz)
